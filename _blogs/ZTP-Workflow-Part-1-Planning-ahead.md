...
A full review of the DHCP process with packet captures is detailed in the blog post: [IOS-XR ZTP: Learning through Packet Captures](https://wwwin-github.cisco.com/pages/spnstme/software-management/blogs/2017-09-20-learning-through-packet-captures-ios-xr-ztp/).
